...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Welcome X-Teamer\n", font=customtkinter.CTkFont(size=20, weight="bold"))
        ...
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame, command=self.sidebar_button_event, text="Client Contract")
        ...
        self.main_button_1 = customtkinter.CTkButton(master=self, fg_color="transparent", border_width=2, text_color=("gray10", "#DCE4EE"), text="Logout")
        ...
        self.bg_image = customtkinter.CTkImage(Image.open(current_path + "/test_images/profile.png"),
                                               size=(790, 570))
        ...
        # set default values
        self.sidebar_button_3.configure(state="disabled", text="Unleash+ Disabled")
